...
describe("AGENTS.md §4 — 文字列で見る検査", () => {
  ...
  it("端の取り方で、どちらへ倒れるかが読める", () => {
    // **手だけを足しても、次に読む人は「どちらへ寄せるか」で止まる**
    // ——**向きが違う**（**広いと踏んだ人が気づける、狭いと誰も気づかない**）。
    // **止めるかどうかの判断に、実際に使われている**（#726 の 2 件）。
    expectOnlyInGuidance("広く取ると偽の赤");
    expectOnlyInGuidance("狭く取ると偽の緑");
  });
